...
public class Quat4f extends Tuple4f implements Serializable
{
    ...
    public final void conjugate(final Quat4f q1) {
        super.x = -((Tuple4f)q1).x;
        super.y = -((Tuple4f)q1).y;
        super.z = -((Tuple4f)q1).z;
        super.w = ((Tuple4f)q1).w;
    }
    ...
    public final void mul(final Quat4f q1, final Quat4f q2) {
        this.set(((Tuple4f)q1).x * ((Tuple4f)q2).w + ((Tuple4f)q1).w * ((Tuple4f)q2).x + ((Tuple4f)q1).y * ((Tuple4f)q2).z - ((Tuple4f)q1).z * ((Tuple4f)q2).y, ((Tuple4f)q1).y * ((Tuple4f)q2).w + ((Tuple4f)q1).w * ((Tuple4f)q2).y + ((Tuple4f)q1).z * ((Tuple4f)q2).x - ((Tuple4f)q1).x * ((Tuple4f)q2).z, ((Tuple4f)q1).z * ((Tuple4f)q2).w + ((Tuple4f)q1).w * ((Tuple4f)q2).z + ((Tuple4f)q1).x * ((Tuple4f)q2).y - ((Tuple4f)q1).y * ((Tuple4f)q2).x, ((Tuple4f)q1).w * ((Tuple4f)q2).w - ((Tuple4f)q1).x * ((Tuple4f)q2).x - ((Tuple4f)q1).y * ((Tuple4f)q2).y - ((Tuple4f)q1).z * ((Tuple4f)q2).z);
    }
    
    public final void mul(final Quat4f q1) {
        this.set(super.x * ((Tuple4f)q1).w + super.w * ((Tuple4f)q1).x + super.y * ((Tuple4f)q1).z - super.z * ((Tuple4f)q1).y, super.y * ((Tuple4f)q1).w + super.w * ((Tuple4f)q1).y + super.z * ((Tuple4f)q1).x - super.x * ((Tuple4f)q1).z, super.z * ((Tuple4f)q1).w + super.w * ((Tuple4f)q1).z + super.x * ((Tuple4f)q1).y - super.y * ((Tuple4f)q1).x, super.w * ((Tuple4f)q1).w - super.x * ((Tuple4f)q1).x - super.y * ((Tuple4f)q1).y - super.z * ((Tuple4f)q1).z);
    }
    
    public final void mulInverse(final Quat4f q1, final Quat4f q2) {
        double n = this.norm();
        n = ((n == 0.0) ? n : (1.0 / n));
        this.set((float)((((Tuple4f)q1).x * ((Tuple4f)q2).w - ((Tuple4f)q1).w * ((Tuple4f)q2).x - ((Tuple4f)q1).y * ((Tuple4f)q2).z + ((Tuple4f)q1).z * ((Tuple4f)q2).y) * n), (float)((((Tuple4f)q1).y * ((Tuple4f)q2).w - ((Tuple4f)q1).w * ((Tuple4f)q2).y - ((Tuple4f)q1).z * ((Tuple4f)q2).x + ((Tuple4f)q1).x * ((Tuple4f)q2).z) * n), (float)((((Tuple4f)q1).z * ((Tuple4f)q2).w - ((Tuple4f)q1).w * ((Tuple4f)q2).z - ((Tuple4f)q1).x * ((Tuple4f)q2).y + ((Tuple4f)q1).y * ((Tuple4f)q2).x) * n), (float)((((Tuple4f)q1).w * ((Tuple4f)q2).w + ((Tuple4f)q1).x * ((Tuple4f)q2).x + ((Tuple4f)q1).y * ((Tuple4f)q2).y + ((Tuple4f)q1).z * ((Tuple4f)q2).z) * n));
    }
    
    public final void mulInverse(final Quat4f q1) {
        double n = this.norm();
        n = ((n == 0.0) ? n : (1.0 / n));
        this.set((float)((super.x * ((Tuple4f)q1).w - super.w * ((Tuple4f)q1).x - super.y * ((Tuple4f)q1).z + super.z * ((Tuple4f)q1).y) * n), (float)((super.y * ((Tuple4f)q1).w - super.w * ((Tuple4f)q1).y - super.z * ((Tuple4f)q1).x + super.x * ((Tuple4f)q1).z) * n), (float)((super.z * ((Tuple4f)q1).w - super.w * ((Tuple4f)q1).z - super.x * ((Tuple4f)q1).y + super.y * ((Tuple4f)q1).x) * n), (float)((super.w * ((Tuple4f)q1).w + super.x * ((Tuple4f)q1).x + super.y * ((Tuple4f)q1).y + super.z * ((Tuple4f)q1).z) * n));
    }
    ...
    public final void inverse(final Quat4f q1) {
        ...
        super.x = (float)(-((Tuple4f)q1).x / n);
        super.y = (float)(-((Tuple4f)q1).y / n);
        super.z = (float)(-((Tuple4f)q1).z / n);
        super.w = (float)(((Tuple4f)q1).w / n);
    }
    ...
    public final void interpolate(final Quat4f q1, final double alpha) {
        ...
        final double x1 = ((Tuple4f)q1).x / n1;
        final double y1 = ((Tuple4f)q1).y / n1;
        final double z1 = ((Tuple4f)q1).z / n1;
        final double w1 = ((Tuple4f)q1).w / n1;
