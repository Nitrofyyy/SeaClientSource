...
public class Matrix3d implements Serializable
{
    ...
    public final void setRow(final int row, final Vector3d v) {
        if (row == 0) {
            this.m00 = ((Tuple3d)v).x;
            this.m01 = ((Tuple3d)v).y;
            this.m02 = ((Tuple3d)v).z;
        }
        else if (row == 1) {
            this.m10 = ((Tuple3d)v).x;
            this.m11 = ((Tuple3d)v).y;
            this.m12 = ((Tuple3d)v).z;
        }
        else {
            if (row != 2) {
                throw new ArrayIndexOutOfBoundsException("row must be 0 to 2 and is " + row);
            }
            this.m20 = ((Tuple3d)v).x;
            this.m21 = ((Tuple3d)v).y;
            this.m22 = ((Tuple3d)v).z;
        }
    }
    ...
    public final void getRow(final int row, final Vector3d v) {
        if (row == 0) {
            ((Tuple3d)v).x = this.m00;
            ((Tuple3d)v).y = this.m01;
            ((Tuple3d)v).z = this.m02;
        }
        else if (row == 1) {
            ((Tuple3d)v).x = this.m10;
            ((Tuple3d)v).y = this.m11;
            ((Tuple3d)v).z = this.m12;
        }
        else {
            if (row != 2) {
                throw new ArrayIndexOutOfBoundsException("row must be 0 to 2 and is " + row);
            }
            ((Tuple3d)v).x = this.m20;
            ((Tuple3d)v).y = this.m21;
            ((Tuple3d)v).z = this.m22;
        }
    }
    ...
    public final void setColumn(final int column, final Vector3d v) {
        if (column == 0) {
            this.m00 = ((Tuple3d)v).x;
            this.m10 = ((Tuple3d)v).y;
            this.m20 = ((Tuple3d)v).z;
        }
        else if (column == 1) {
            this.m01 = ((Tuple3d)v).x;
            this.m11 = ((Tuple3d)v).y;
            this.m21 = ((Tuple3d)v).z;
        }
        else {
            if (column != 2) {
                throw new ArrayIndexOutOfBoundsException("col must be 0 to 2 and is " + column);
            }
            this.m02 = ((Tuple3d)v).x;
            this.m12 = ((Tuple3d)v).y;
            this.m22 = ((Tuple3d)v).z;
        }
    }
    ...
    public final void getColumn(final int column, final Vector3d v) {
        if (column == 0) {
            ((Tuple3d)v).x = this.m00;
            ((Tuple3d)v).y = this.m10;
            ((Tuple3d)v).z = this.m20;
        }
        else if (column == 1) {
            ((Tuple3d)v).x = this.m01;
            ((Tuple3d)v).y = this.m11;
            ((Tuple3d)v).z = this.m21;
        }
        else {
            if (column != 2) {
                throw new ArrayIndexOutOfBoundsException("column must be 0 to 2 and is " + column);
            }
            ((Tuple3d)v).x = this.m02;
            ((Tuple3d)v).y = this.m12;
            ((Tuple3d)v).z = this.m22;
        }
    }
