...
public class GameSettings
{
    ...
    public KeyBinding HUD_CONFIG;
    public KeyBinding SPRINTING;
    public KeyBinding ZOOM;
    public KeyBinding CLIENT_PERSPECTIVE;
    public float gammaSettings;
    ...
    public GameSettings(final Minecraft mcIn, final File optionsFileIn) {
        ...
        this.HUD_CONFIG = new KeyBinding("Hud Position", 54, "SeaClient");
        this.SPRINTING = new KeyBinding("SPRINT", 48, "Seaclient");
        this.ZOOM = new KeyBinding("ZOOM", 46, "SeaClient");
        this.CLIENT_PERSPECTIVE = new KeyBinding("Toggle Perspective", 25, "Seaclient");
    ...
    private void addClientKeybinds() {
        ...
        this.keyBindings = (KeyBinding[])ArrayUtils.add((Object[])this.keyBindings, (Object)this.SPRINTING);
