...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(final float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            Vec3 vec6 = null;
            final float f = 1.0f;
            final List<Entity> list = this.mc.theWorld.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(vec4.xCoord * d0, vec4.yCoord * d0, vec4.zCoord * d0).expand(1.0, 1.0, 1.0), (Predicate<? super Entity>)Predicates.and((Predicate)EntitySelectors.NOT_SPECTATING, (Predicate)new Predicate<Entity>() {
    ...
    public float getFOVModifier(final float partialTicks, final boolean useFOVSetting) {
        if (this.debugView) {
            return 90.0f;
        }
        final Entity entity = this.mc.getRenderViewEntity();
    ...
    private void setupViewBobbing(final float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            final float f3 = ModManager.getModPerspective().getCameraYaw() + (ModManager.getModPerspective().getCameraYaw() - ModManager.getModPerspective().getCameraYaw()) * partialTicks;
            final float f4 = ModManager.getModPerspective().getCameraPitch() + (entityplayer.cameraPitch - ModManager.getModPerspective().getCameraPitch()) * partialTicks;
    ...
    private void orientCamera(final float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
            ...
            if (!this.mc.gameSettings.debugCamEnable) {
                ...
                GlStateManager.rotate(ModManager.getModPerspective().getCameraYaw() + (ModManager.getModPerspective().getCameraYaw() - ModManager.getModPerspective().getCameraYaw()) * partialTicks + 180.0f, 0.0f, -1.0f, 0.0f);
                GlStateManager.rotate(ModManager.getModPerspective().getCameraPitch() + (ModManager.getModPerspective().getCameraPitch() - ModManager.getModPerspective().getCameraPitch()) * partialTicks, -1.0f, 0.0f, 0.0f);
            }
        }
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                final float f2 = ModManager.getModPerspective().getCameraYaw();
                float f3 = ModManager.getModPerspective().getCameraPitch();
                ...
                GlStateManager.rotate(ModManager.getModPerspective().getCameraPitch() - f3, 1.0f, 0.0f, 0.0f);
                GlStateManager.rotate(ModManager.getModPerspective().getCameraYaw() - f2, 0.0f, 1.0f, 0.0f);
                GlStateManager.translate(0.0f, 0.0f, (float)(-d4));
                GlStateManager.rotate(f2 - ModManager.getModPerspective().getCameraYaw(), 0.0f, 1.0f, 0.0f);
                GlStateManager.rotate(f3 - ModManager.getModPerspective().getCameraPitch(), 1.0f, 0.0f, 0.0f);
            }
        }
        else {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists()) {
            if (!this.mc.gameSettings.debugCamEnable) {
                float f7 = ModManager.getModPerspective().getCameraYaw() + (ModManager.getModPerspective().getCameraYaw() - ModManager.getModPerspective().getCameraYaw()) * partialTicks + 180.0f;
                float f8 = ModManager.getModPerspective().getCameraPitch() + (ModManager.getModPerspective().getCameraPitch() - ModManager.getModPerspective().getCameraPitch()) * partialTicks;
                float f9 = 0.0f;
    ...
    private void frameInit() {
        ...
        if (world != null) {
            if (Config.getNewRelease() != null) {
                ...
                final String s2 = String.valueOf(String.valueOf(s)) + " " + Config.getNewRelease();
