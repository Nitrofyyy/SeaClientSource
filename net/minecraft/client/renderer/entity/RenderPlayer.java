...
import BLueDD.cosmetic.impl.Skine;
import BLueDD.cosmetic.impl.CosmeticDragonWings;
...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    public RenderPlayer(final RenderManager renderManager, final boolean useSmallArms) {
        ...
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new Skine(this));
    }
    ...
    public void bindTexture(final AnimatedResourceLocation animatedResourceLocation) {
    }
}
