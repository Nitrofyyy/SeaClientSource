        ...
        if (d0 <= maxDistance * maxDistance) {
            ...
            if (entityIn instanceof AbstractClientPlayer) {
                if (entityIn.getName().equals(Minecraft.getMinecraft().getSession().getUsername())) {
                    Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("BLueDD/logo.png"));
                ...
                if (entityIn.getName().equals("SeaClient") || entityIn.getName().equals("ItsMiCha") || entityIn.getName().equals("Radiant_Kaladin") || entityIn.getName().equals("0hSlike_IQ")) {
                    Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("BLueDD/logosupreme.png"));
                    Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entityIn.getDisplayName().getFormattedText()) / 2 - 15, -3, 15.0f, 15.0f, 15, 15, 15.0f, 15.0f);
                }
                if (entityIn.getName().equals("Walibear") || entityIn.getName().equals("ItsMiCha")) {
                    Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("BLueDD/logoyt.png"));
                    Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entityIn.getDisplayName().getFormattedText()) / 2 - 15, -3, 15.0f, 15.0f, 15, 15, 15.0f, 15.0f);
                }
            }
