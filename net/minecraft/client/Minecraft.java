...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException {
        try {
            final File myObj = new File("AresFolder/Mail.txt");
            final Scanner myReader = new Scanner(myObj);
            while (myReader.hasNextLine()) {
                final String data = GuiAltLogin.Email = myReader.nextLine();
            }
            myReader.close();
        }
        ...
        try {
            final File myObj = new File("AresFolder/Pass.txt");
            final Scanner myReader = new Scanner(myObj);
            while (myReader.hasNextLine()) {
                final String data = GuiAltLogin.Password = myReader.nextLine();
            }
            myReader.close();
        }
        catch (FileNotFoundException e) {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Loading " + Client.namever);
        try {
    ...
    public void runTick() throws IOException {
        ...
        final ClientTick event2 = new ClientTick();
        event2.call();
        this.mcProfiler.endSection();
        this.systemTime = getSystemTime();
    }
