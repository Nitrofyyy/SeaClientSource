...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(200, GuiIngameMenu.width / 2 - 100, GuiIngameMenu.height / 4 + 72 + i, 200, 20, "Multiplayer"));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, I18n.format("menu.game", new Object[0]), (float)(GuiIngameMenu.width / 2), 40.0f, 16777215);
        this.mc.getTextureManager().bindTexture(new ResourceLocation("BLueDD/logo_Inventory.png"));
        Gui.drawModalRectWithCustomSizedTexture(GuiIngameMenu.width / 1000, GuiIngameMenu.height / -10 / 28, 100.0f, 100.0f, 100, 50, 100.0f, 50.0f);
