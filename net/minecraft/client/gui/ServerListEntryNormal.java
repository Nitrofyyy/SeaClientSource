...
import BLueDD.ServerDataFeatured;
...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    private static final ServerDataFeatured ServerData;
    ...
    public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
        ...
        final boolean isFeaturedServer = this.server instanceof ServerDataFeatured;
        if (isFeaturedServer) {
            this.drawImg(x, y, false, ServerDataFeatured.STAR_ICON);
        }
    ...
    private void drawImg(final int x, final int y, final boolean lower, final ResourceLocation starIcon) {
        this.mc.getTextureManager().bindTexture(starIcon);
        Gui.drawModalRectWithCustomSizedTexture(x - 16, lower ? (y + 16) : y, 0.0f, 0.0f, 16, 16, 16.0f, 16.0f);
    }
