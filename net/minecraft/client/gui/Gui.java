...
public class Gui
{
    ...
    public static void drawCenteredString(final FontRenderer fontRendererIn, final String text, final float f, final float g, final int color) {
        fontRendererIn.drawStringWithShadow(text, f - fontRendererIn.getStringWidth(text) / 2, g, color);
    }
    ...
    public static void drawString(final String string, final int i, final float f, final int y, final boolean b) {
    }
}
