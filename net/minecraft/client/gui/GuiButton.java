...
public class GuiButton extends Gui
{
    ...
    public GuiButton(final int i, final int j, final int k, final int l, final TimeType timeType) {
    }
    ...
    public void drawButton(final Minecraft mc, final int mouseX, final int mouseY) {
        if (this.visible) {
            ...
            Gui.drawCenteredString(fontrenderer, this.displayString, (float)(this.xPosition + this.width / 2), (float)(this.yPosition + (this.height - 8) / 2), j);
        }
    }
