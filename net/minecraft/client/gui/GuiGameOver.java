...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, s, (float)(GuiGameOver.width / 2 / 2), 30.0f, 16777215);
        GlStateManager.popMatrix();
        if (flag) {
            Gui.drawCenteredString(this.fontRendererObj, I18n.format("deathScreen.hardcoreInfo", new Object[0]), (float)(GuiGameOver.width / 2), 144.0f, 16777215);
        }
        Gui.drawCenteredString(this.fontRendererObj, String.valueOf(I18n.format("deathScreen.score", new Object[0])) + ": " + EnumChatFormatting.YELLOW + this.mc.thePlayer.getScore(), (float)(GuiGameOver.width / 2), 100.0f, 16777215);
