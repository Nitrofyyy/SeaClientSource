...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.loadingAchievements) {
            ...
            Gui.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), (float)(GuiAchievements.width / 2), (float)(GuiAchievements.height / 2), 16777215);
            Gui.drawCenteredString(this.fontRendererObj, GuiAchievements.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiAchievements.lanSearchStates.length)], (float)(GuiAchievements.width / 2), (float)(GuiAchievements.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2), 16777215);
        }
        else {
