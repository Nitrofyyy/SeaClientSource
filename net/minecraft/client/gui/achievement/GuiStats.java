...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            Gui.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), (float)(GuiStats.width / 2), (float)(GuiStats.height / 2), 16777215);
            Gui.drawCenteredString(this.fontRendererObj, GuiStats.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiStats.lanSearchStates.length)], (float)(GuiStats.width / 2), (float)(GuiStats.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2), 16777215);
        }
        else {
            this.displaySlot.drawScreen(mouseX, mouseY, partialTicks);
            Gui.drawCenteredString(this.fontRendererObj, this.screenTitle, (float)(GuiStats.width / 2), 20.0f, 16777215);
