...
public class ConnectedParser
{
    ...
    private boolean matchState(final IBlockState iblockstate1, final Map<IProperty, List<Comparable>> map) {
        return true;
    }
    ...
    public static Comparable parsePropertyValue(final IProperty prop, final String valStr) {
        ...
        Comparable comparable = parseValue(valStr, oclass, (Object)null);
        if (comparable == null) {
    ...
    public static <right, getFunctionType, In> Comparable parseValue(final String str, final Class cls, final getFunctionType ExpressionParser) {
        final String name;
        switch (name = cls.getName()) {
