...
public class GuiShaderOptions extends GuiScreenOF
{
    ...
    public void drawScreen(final int x, final int y, final float f) {
        ...
        if (this.screenText != null) {
            Gui.drawCenteredString(this.fontRendererObj, this.screenText, (float)(GuiShaderOptions.width / 2), 15.0f, 16777215);
        }
        else {
            Gui.drawCenteredString(this.fontRendererObj, this.title, (float)(GuiShaderOptions.width / 2), 15.0f, 16777215);
        }
