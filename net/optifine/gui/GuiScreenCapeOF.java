...
public class GuiScreenCapeOF extends GuiScreenOF
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRenderer, this.title, (float)(GuiScreenCapeOF.width / 2), 20.0f, 16777215);
        if (this.message != null) {
            Gui.drawCenteredString(this.fontRenderer, this.message, (float)(GuiScreenCapeOF.width / 2), (float)(GuiScreenCapeOF.height / 6 + 60), 16777215);
