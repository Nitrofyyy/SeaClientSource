...
package BLueDD.cosmetic.impl;

import net.minecraft.client.model.ModelBase;
import BLueDD.cosmetic.CosmeticModelBase;
...
import BLueDD.cosmetic.CosmeticBase;

public class SUB extends CosmeticBase
{
    private final GlassesRenderer glassesModel;
    
    public SUB(final RenderPlayer renderPlayer) {
        super(renderPlayer);
    ...
    public class GlassesRenderer extends CosmeticModelBase
    {
        ...
        public GlassesRenderer(final RenderPlayer player) {
            ...
            SUB.this.setRotation(this.Glasses1, 0.0f, 0.0f, 0.0f);
            ...
            SUB.this.setRotation(this.Glasses2, 0.0f, 0.0f, 0.0f);
            ...
            SUB.this.setRotation(this.Glasses3, 0.0f, 0.0f, 0.0f);
            ...
            SUB.this.setRotation(this.Glasses4, 0.0f, 0.0f, 0.0f);
            ...
            SUB.this.setRotation(this.Glasses5, 0.0f, 0.0f, 0.0f);
            ...
            SUB.this.setRotation(this.Glasses6, 0.0f, 0.0f, 0.0f);
            ...
            SUB.this.setRotation(this.Glasses7, 0.0f, 0.0f, 0.0f);
            ...
            SUB.this.setRotation(this.Glasses8, 0.0f, 0.0f, 0.0f);
            ...
            SUB.this.setRotation(this.Glasses9, 0.0f, 0.0f, 0.0f);
        }
