...
public class PasswordField extends Gui
{
    ...
    public void writeText(final String par1Str) {
        ...
        if (this.text.length() > 0) {
            var2 = String.valueOf(String.valueOf(String.valueOf(String.valueOf(var2)))) + this.text.substring(0, var4);
        }
        int var8;
        if (var6 < var3.length()) {
            var2 = String.valueOf(String.valueOf(String.valueOf(String.valueOf(var2)))) + var3.substring(0, var6);
            var8 = var6;
        }
        else {
            var2 = String.valueOf(String.valueOf(String.valueOf(String.valueOf(var2)))) + var3;
            var8 = var3.length();
        }
        if (this.text.length() > 0 && var5 < this.text.length()) {
            var2 = String.valueOf(String.valueOf(String.valueOf(String.valueOf(var2)))) + this.text.substring(var5);
        }
        ...
        if (this.text.length() != 0) {
            if (this.selectionEnd != this.cursorPosition) {
                ...
                if (var4 < this.text.length()) {
                    var5 = String.valueOf(String.valueOf(String.valueOf(String.valueOf(var5)))) + this.text.substring(var4);
                }
                this.text = var5;
                if (var2) {
                    this.cursorPos(par1);
